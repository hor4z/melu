...
export const REGISTRY: Entry[] = [
  ...
  },
  {
    ...
    exports: ['DropdownMenu', 'DropdownMenuTrigger', 'DropdownMenuContent', 'DropdownMenuItem', 'DropdownMenuCheckboxItem', 'DropdownMenuLabel', 'DropdownMenuSeparator', 'DropdownMenuGroup', 'MoreMenu', 'MenuButton'],
    demos: [
      ...
      { id: 'menu-button', title: 'El disparador que muestra qué hay elegido', note: 'Un visual, una etiqueta, una línea abajo y el chevron. Lo usan el menú de la cuenta y el selector de espacios.' },
    ],
  ...
  },
  {
    ...
    title: 'Filter',
    group: 'Datos',
    summary: 'La barra que achica una tabla: el texto, los filtros que se agregan y el reset.',
    exports: ['FilterSet', 'Filter', 'FilterBar', 'FilterSearch', 'FilterReset', 'facets'],
    demos: [
      ...
      { id: 'barra', title: 'La barra entera', note: '`FilterSet` es un botón mientras no hay nada filtrando, y el filtro que elegís aparece con su panel abierto. Cada opción cuenta sobre lo que dejan los otros: eso lo hace `facets`, y por eso el número no miente.' },
    ],
    when: [
      ...
      'Hay más de dos filtros posibles: `FilterSet` los guarda hasta que alguien los pide.',
    ],
    whenNot: [
      'Tres opciones exclusivas y siempre visibles son un `SegmentedControl`: un panel para tres cosas es de más.',
      'Un solo filtro, siempre el mismo: ponelo suelto con `Filter` y ahorrale a la persona el paso de agregarlo.',
  ...
  },
  {
    ...
    title: 'La marca',
    group: 'Marca',
    summary: 'El logo, el marco de foto y los doodles, que hoy son placeholders.',
    exports: [
      'Logo', 'Logomark', 'PhotoFrame',
    ...
    demos: [
      ...
      { id: 'doodles', title: 'Doodles', note: 'Los diez, también en el objeto `DOODLES` para recorrerlos. Son placeholders: la API no va a cambiar cuando entre el arte de verdad.' },
    ],
