/**
 * Los tests del tacto. Cada uno describe algo que se siente al escribir, no una función.
 *
 * El orden de las ramas de Enter y de Backspace es la mitad de la experiencia de un editor de
 * bloques, y es también lo que se rompe primero cuando alguien toca el motor. Así que están
 * enunciados como se sienten: "un ítem de lista vacío deja de ser lista", y no "splitBlock con
 * texto vacío y spec.split.empty definido".
 */

import { describe, expect, it } from 'vitest'
import { at, caretAt, editorWith, ids, makeEditor, press, selectBlocks, selectRange, sketch, textAt, type, typeAt, where } from './helpers.ts'
